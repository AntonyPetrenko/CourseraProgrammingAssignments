    ...
    public class TeddyBear
    {
        ...
        public void Update(GameTime gameTime)
        {
            ...
            if (elapsedShotMilliseconds >= firingDelay)
            {
                ...
                firingDelay = GetRandomFiringDelay();
                Projectile teddyBearProjectile = new Projectile(ProjectileType.TeddyBear, Game1.GetProjectileSprite(ProjectileType.TeddyBear), (drawRectangle.X + sprite.Width / 2), (drawRectangle.Y + GameConstants.TeddyBearProjectileOffset), -GetProjectileYVelocity()* -1);
