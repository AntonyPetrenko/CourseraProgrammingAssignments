...
namespace ProgrammingAssignment2
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        Texture2D SpaceShip0;
        Texture2D SpaceShip1;
        ...
        protected override void LoadContent()
        {
            ...
            background3 = Content.Load<Texture2D>(@"graphics\background3");

            SpaceShip0 = Content.Load<Texture2D>(@"graphics\SpaceShip0");

            SpaceShip1 = Content.Load<Texture2D>(@"graphics\SpaceShip1");

            SpaceShip2 = Content.Load<Texture2D>(@"graphics\SpaceShip2");



            // STUDENTS: set the currentSprite variable to one of your sprite variables

            currentSprite = SpaceShip0;
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (elapsedTime > ChangeDelayTime)
            {
                ...
                int spriteNumber = rand.Next(2 - 0 + 1) + 0;
                ...
                {
                    currentSprite = SpaceShip1;
                }
                else if (spriteNumber == 2)
                {
                    currentSprite = SpaceShip2;
                }
                ...
                speedX = rand.Next(-2, 4);
                speedY = rand.Next(-2, 4);
            }
