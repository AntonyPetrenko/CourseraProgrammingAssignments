    ...
    public class Burger
    {
        ...
        public void Update(GameTime gameTime, KeyboardState keyboard)
        {
            ...
            if (health > 0)
            {
                ...
                if (keyboard.IsKeyDown(Keys.Right) || keyboard.IsKeyDown(Keys.P))
                {
                    velocity += new Vector2(1, 0);
                }
                if (keyboard.IsKeyDown(Keys.Left) || keyboard.IsKeyDown(Keys.O))
                {
                    velocity += new Vector2(-1, 0);
                }
                if (keyboard.IsKeyDown(Keys.Down) || keyboard.IsKeyDown(Keys.A))
                {
                    velocity += new Vector2(0, 1);
                }
                if (keyboard.IsKeyDown(Keys.Up) || keyboard.IsKeyDown(Keys.Q))
                {
                    velocity += new Vector2(0, -1);
                }
        ...
        public int Health
        {
            ...
            set
            {
                ...
                if (value > GameConstants.BurgerInitialHealth)

                {
                    value = GameConstants.BurgerInitialHealth;
