...
namespace ProgrammingAssignment6
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            playerHand[0].Y = VerticalCardSpacing;

            // first dealer card
            dealerHand.Add(deck.TakeTopCard());
            dealerHand[0].X = HorizontalCardOffset - TopCardOffset;
            dealerHand[0].Y = VerticalCardSpacing - TopCardOffset;

            // second player card
            playerHand.Add(deck.TakeTopCard());
            playerHand[1].FlipOver();
            playerHand[1].X = HorizontalCardOffset;
            playerHand[1].Y = VerticalCardSpacing;


            // second dealer card
            dealerHand.Add(deck.TakeTopCard());
            dealerHand[1].X = HorizontalCardOffset - TopCardOffset;
            dealerHand[1].Y = VerticalCardSpacing - TopCardOffset;


            // load sprite font, create message for player score and add to list
            //messageFont = Content.Load<SpriteFont>(@"fonts\Arial24");
            //playerScoreMessage = new Message(ScoreMessagePrefix + GetBlockjuckScore(playerHand).ToString(), messageFont, new Vector2(HorizontalCardOffset, ScoreMessageTopOffset));
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            // draw hands
            playerHand[0].Draw(spriteBatch);

            dealerHand[0].Draw(spriteBatch);
